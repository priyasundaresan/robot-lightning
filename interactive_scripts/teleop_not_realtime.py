...
class InteractiveBot:
    ...
    def rgbd2pointCloud(self, rgb_frame, depth_frame):
        ...
        idxs = crop(points_3d, min_bound=[0.35, -0.24, -0.02], max_bound=[0.76, 0.24, 0.4])
    ...
    def test_ui(self):
        ...
        idxs = np.random.choice(np.arange(len(points)), 2000, replace=False)
        points = points[idxs]
        colors = colors[idxs]
        ...
        handler = MyWebSocketHandler(shared_pose, pcl_queue)
